...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">实验设备网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- 
                 <li><a href="<%=basePath %>UserInfo/frontlist">采购员</a></li>
                <li><a href="<%=basePath %>Zuzhang/frontlist">组长</a></li>
                <li><a href="<%=basePath %>DeviceClass/frontlist">设备类别</a></li>
                <li><a href="<%=basePath %>ShiyanState/frontlist">实验状态</a></li>
                <li><a href="<%=basePath %>DeviceItem/frontlist">设备条目</a></li> -->
                <li><a href="<%=basePath %>Device/frontlist">实验设备</a></li>
                <li><a href="<%=basePath %>Purchase/frontlist">设备采购</a></li>
                <li><a href="<%=basePath %>Shiyan/frontlist">实验列表</a></li>
                
                <li><a href="<%=basePath %>Fankui/frontlist">反馈日志</a></li>
                <li><a href="<%=basePath %>Repair/frontlist">设备维修</a></li>
                <li><a href="<%=basePath %>Scrap/frontlist">设备报废</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>UserInfo/userInfo_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;采购员注册</a></li>
                <li><a href="<%=basePath %>Zuzhang/zuzhang_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;组长注册</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>DeviceClass/frontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;设备类别管理</a></li>
                        <li><a href="<%=basePath %>Purchase/purchase_frontUserAdd.jsp"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;设备采购登记</a></li>
                        <li><a href="<%=basePath %>Purchase/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的设备采购记录</a></li>
