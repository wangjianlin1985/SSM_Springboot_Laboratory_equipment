...
<jsp:include page="check_zuzhang_logstate.jsp"/>
...
<div data-options="region:'north',title:'header',split:true,noheader:true" style="height:60px;background-color:#01B1EA;">
	<div class="logo">生物实验室设备管理后台管理</div>
	<div class="logout">您好，<%=session.getAttribute("zuzhang")%> | <a href="logout">退出</a></div>
</div>   
...
<script type="text/javascript" src="js/admin_zuzhang.js"></script>
