...
public class DeviceClassController extends BaseController {
	...
	public void listAll(HttpServletResponse response) throws Exception {
		...
		for(DeviceClass deviceClass:deviceClassList) {
			...
			jsonDeviceClass.accumulate("deviceClassId", deviceClass.getDeviceClassId());
			jsonDeviceClass.accumulate("deviceClassName", deviceClass.getDeviceClassName());
			jsonArray.put(jsonDeviceClass);
		}
	...
	public String frontlist(Integer currentPage, Model model, HttpServletRequest request) throws Exception  {
     ...
     /*前台查询DeviceClass信息*/
	@RequestMapping(value="/{deviceClassId}/frontshow",method=RequestMethod.GET)
	public String frontshow(@PathVariable Integer deviceClassId,Model model,HttpServletRequest request) throws Exception {
		/*根据主键deviceClassId获取DeviceClass对象*/
        DeviceClass deviceClass = deviceClassService.getDeviceClass(deviceClassId);
	...
	@RequestMapping(value="/{deviceClassId}/update",method=RequestMethod.GET)
	public void update(@PathVariable Integer deviceClassId,Model model,HttpServletRequest request,HttpServletResponse response) throws Exception {
        /*根据主键deviceClassId获取DeviceClass对象*/
        DeviceClass deviceClass = deviceClassService.getDeviceClass(deviceClassId);
	...
	/*ajax方式更新设备类别信息*/
	@RequestMapping(value = "/{deviceClassId}/update", method = RequestMethod.POST)
    ...
    /*删除设备类别信息*/
	@RequestMapping(value="/{deviceClassId}/delete",method=RequestMethod.GET)
	public String delete(@PathVariable Integer deviceClassId,HttpServletRequest request) throws UnsupportedEncodingException {
		  try {
	...
	public void delete(String deviceClassIds,HttpServletRequest request,HttpServletResponse response) throws IOException, JSONException {
		String message = "";
    	boolean success = false;
        try { 
        	int count = deviceClassService.deleteDeviceClasss(deviceClassIds);
        	success = true;
	...
	public void OutToExcel( Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        String[] headers = { "设备类别id","设备类别名称"};
        List<String[]> dataset = new ArrayList<String[]>(); 
        for(int i=0;i<deviceClassList.size();i++) {
        	DeviceClass deviceClass = deviceClassList.get(i); 
        	dataset.add(new String[]{deviceClass.getDeviceClassId() + "",deviceClass.getDeviceClassName()});
        }
        /*
